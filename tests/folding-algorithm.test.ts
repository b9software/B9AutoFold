...
describe('Folding Algorithm Tests', () => {
	...
	it('should fold methods in a class when file is large', () => {
		// biome-ignore format: skip
		check('manager.ts', 120, [
			['Manager', SymbolKind.Class, 13, 116, [
	...
	it('should fold interfaces and enums when space is limited', () => {
		// biome-ignore format: skip
		check('interfaces.ts', 180, [
			['interface 1', SymbolKind.Interface, 9, 54, [
				['p1', SymbolKind.Property, 11, 11, []],
				['m1', SymbolKind.Method, 53, 53, []],
				['m2', SymbolKind.Method, 43, 43, []],
			]],
			['interface 2', SymbolKind.Interface, 56, 61, [
				['hide', SymbolKind.Method, 60, 60, []]
			]],
			['enum1', SymbolKind.Enum, 64, 69, [
	...
	it('should handle test files specially - fold containers but not describe blocks', () => {
		// biome-ignore format: skip
		check('some.test.ts', 130, [
			['some tests', SymbolKind.Function, 17, 125, [
	...
	it('should respect size thresholds based on remaining space', () => {
		// biome-ignore format: skip
		check('methods.ts', 60, [
			['SmallMethod', SymbolKind.Method, 1, 4, []],
			['MediumMethod', SymbolKind.Method, 6, 15, []],
			['LargeMethod', SymbolKind.Method, 17, 50, []],
		], [], [
			[17, 50]
		]);
	});
	...
	it('should correctly fold nested symbols with multi-level children', () => {
		// biome-ignore format: skip
		check('big-func.ts', 59, [
			['root var', SymbolKind.Variable, 17, 17, []],
			// biome-ignore format: skip
			['root func', SymbolKind.Function, 19, 57, [
				['v1', SymbolKind.Property, 21, 24, [
	...
	it('should fold deeply nested properties', () => {
		// biome-ignore format: skip
		check('Text.tsx', 123, [
			['p1', SymbolKind.Variable, 10, 58, [
				['p2', SymbolKind.Property, 11, 57, [
					['p3-1', SymbolKind.Property, 45, 50, [
					...
					['p3-2', SymbolKind.Property, 37, 44, [
					...
					['p3-3', SymbolKind.Property, 26, 36, [
					...
					['p3-6', SymbolKind.Property, 12, 25, [
			...
			['interface', SymbolKind.Interface, 75, 80, [
				['as', SymbolKind.Property, 77, 77, []],
				['asChild', SymbolKind.Property, 78, 78, []],
				['className', SymbolKind.Property, 79, 79, []],
			]],
			['Text', SymbolKind.Variable, 82, 120, [
				['func', SymbolKind.Function, 83, 119, [
					['p1', SymbolKind.Property, 109, 109, []],
					['p2', SymbolKind.Property, 112, 112, []],
					['p3', SymbolKind.Property, 108, 108, []],
					['v1', SymbolKind.Variable, 98, 100, []],
					['p4', SymbolKind.Property, 107, 107, []],
					['p5', SymbolKind.Property, 110, 110, []],
					['p6', SymbolKind.Property, 111, 111, []],
					['p7', SymbolKind.Property, 106, 106, []],
				]],
			]],
		], [], [
			[11, 57], // p2
